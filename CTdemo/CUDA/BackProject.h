...
__global__ void cudaBackProjectKernel(float* d_pDst, float* d_prj, int width, int height, int rays, int angles, float *cos_fai, float *sin_fai, float delta_r, float delta_fai, int cx, int cy, int med);